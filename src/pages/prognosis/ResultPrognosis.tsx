...
import { Home, TrendingUp, ChevronRight, ArrowLeft, AlertTriangle, CheckCircle, Clock } from "lucide-react";
import Footer from "../../components/layout/Footer";

const ResultPrognosis: React.FC = () => {
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="flex items-center gap-1.5 text-xs text-slate-500">
            ...
            <Link to="/prognosis" className="hover:text-slate-700">Prognosis</Link>
            <ChevronRight size={12}/>
        ...
        <div className="max-w-3xl mx-auto space-y-5 animate-fadeIn">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-[#1E3A5F]">AI Prognosis Report</h1>
          ...
          {predictionResult ? (
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 text-center">
              ...
              <p className="text-sm text-slate-500 max-w-sm mx-auto">
                No prognosis data found. Please complete the upload step to generate a result.
              </p>
            </div>
          )}

          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-xs text-amber-800">
            <strong>Clinical Note:</strong> Prognosis predictions are AI-assisted estimates. All results
            must be reviewed and validated by a qualified oncologist.
          </div>
